  ...
  return (
    ...
    >
      ...
      <Link href="/" className="flex items-center gap-2.5 group">
        <Aperture
          className="size-6 text-foreground transition-transform duration-300 group-hover:rotate-45"
          strokeWidth={2.25}
          absoluteStrokeWidth
        />
        <span className="inline-flex items-baseline font-heading text-lg sm:text-xl md:text-2xl">
      ...
      {/* ── Right: Capsule bar ────────────────────── */}
      <div className="flex items-center gap-x-3 rounded-full bg-card/60 px-3 py-2 backdrop-blur-md ring-1 ring-border/50 sm:gap-x-5 sm:px-5">
        {/* Theme switcher */}
        <ThemeSwitcher />
        ...
        {/* Map */}
        <Link href="/map" aria-label="地图">
          <Globe
            className="size-[22px] cursor-pointer text-foreground transition-colors duration-200 hover:text-muted-foreground"
            strokeWidth={2.25}
            absoluteStrokeWidth
          />
        </Link>
        ...
        >
          <svg
            viewBox="0 0 24 24"
            className="size-[22px] cursor-pointer fill-foreground transition-colors duration-200 hover:fill-muted-foreground"
          >
        ...
        {/* Admin */}
        <Link href="/admin" className="hidden md:inline-flex" aria-label="管理后台">
          <LayoutDashboard
            className="size-[22px] cursor-pointer text-foreground transition-colors duration-200 hover:text-muted-foreground"
            strokeWidth={2.25}
            absoluteStrokeWidth
